...
<form action="/Resultado2" method="POST">
    ...
    <div class="row">
        ...
        <div class="col">
            <label for="quantidade_quilos">Informe a quantidade de quilos do produto:</label>
            <input class="form-control" type="text" name="quantidade_quilos" id="quantidade_quilos"/>
        </div>
    </div>
    <div class="row">
        <div class="col">
