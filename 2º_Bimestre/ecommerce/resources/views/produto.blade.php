            ...
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @if(\Illuminate\Support\Facades\Auth::user()->role === "cliente")
                        ...
                        <div class="flex items-center">
                            ...
                            <a href="{{ url('/carrinho/vercarrinho') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Carrinho</a>
                    ...
                    <div class="max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 mr-2" >
                        ...
                        <div class="px-5 pb-5">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <a href="/carrinho/adicionar/{{$produto->id}}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Comprar</a>
                            </div>
                        </div>
                    </div>
